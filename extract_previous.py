...
from databasemanager import RawDrawResults, UploadRecordTable, engine
...
def upload_to_db(table: list): # missing validation on duplicate upload of file.
    ...
    with Session(engine) as session:
        ...
        for sublist in table:
            ...
            lotto_result= RawDrawResults(raw_lotto_game=game,
...
table = get_result_by_date(date(2024, 3, 1), date(2024, 3, 5))
